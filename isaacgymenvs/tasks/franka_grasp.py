...
class FrankaGrasp(VecTask):
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        # Dimensions
        # obs include: eef_pose (7) + q_gripper (2) + cube_pose (7)
        #              eef_pose (7) + q_gripper (2) + cube_pose (7) + q(7)
    ...
    def create_sim(self):
        ...
        # Create envs and initialize all data
    ...
    def _create_envs(self, spacing, num_per_row):
        ...
        max_agg_bodies = num_franka_bodies + 2  # 1 for table, table stand, cubeA, cubeB
        max_agg_shapes = num_franka_shapes + 2  # 1 for table, table stand, cubeA, cubeB
        ...
        for i in range(self.num_envs):
            ...
            table_stand_actor = self.gym.create_actor(env_ptr, table_stand_asset, table_stand_start_pose,
                                                      "table_stand", i, 1, 0)
